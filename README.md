...
<br/>
**latest release: [5.1](https://search.maven.org/artifact/pl.morgwai.base/guice-context-scopes/5.1/jar)**
([javadoc](https://javadoc.io/doc/pl.morgwai.base/guice-context-scopes/5.1))
