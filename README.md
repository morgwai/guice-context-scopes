...
<br/>
**latest release: [6.2](https://search.maven.org/artifact/pl.morgwai.base/guice-context-scopes/6.2/jar)**
([javadoc](https://javadoc.io/doc/pl.morgwai.base/guice-context-scopes/6.2))
