...
<br/>
**latest release: [10.4](https://search.maven.org/artifact/pl.morgwai.base/guice-context-scopes/10.4/jar)**
([javadoc](https://javadoc.io/doc/pl.morgwai.base/guice-context-scopes/10.4))
