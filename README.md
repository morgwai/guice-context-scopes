...
<br/>
**latest release: [9.6](https://search.maven.org/artifact/pl.morgwai.base/guice-context-scopes/9.6/jar)**
([javadoc](https://javadoc.io/doc/pl.morgwai.base/guice-context-scopes/9.6))
