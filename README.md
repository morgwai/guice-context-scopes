...
<br/>
**latest release: [10.3](https://search.maven.org/artifact/pl.morgwai.base/guice-context-scopes/10.3/jar)**
([javadoc](https://javadoc.io/doc/pl.morgwai.base/guice-context-scopes/10.3))
