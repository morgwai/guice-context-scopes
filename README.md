...
<br/>
**latest release: [6.1](https://search.maven.org/artifact/pl.morgwai.base/guice-context-scopes/6.1/jar)**
([javadoc](https://javadoc.io/doc/pl.morgwai.base/guice-context-scopes/6.1))
