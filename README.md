...
<br/>
**latest release: [6.4](https://search.maven.org/artifact/pl.morgwai.base/guice-context-scopes/6.4/jar)**
([javadoc](https://javadoc.io/doc/pl.morgwai.base/guice-context-scopes/6.4))
